...
flds = c('id,decimalLongitude,decimalLatitude,
      yearcollected,dateIdentified,
...
#write_csv(D, file.path(dir_obis, 'obis_occ.csv')) # 1,789 MB
saveRDS(D, file.path(dir_obis, 'obis_occ.rds'))   #   111 MB
