...
## Simplify EEZ for Plotting and OBIS Querying
...
Above are the first 6 of `r nrow(obis_sf) %>% comma()` OBIS attributes.
...
Or directly download: https://www.protectedplanet.net/downloads/WDPA_Sep2017?type=shapefile
